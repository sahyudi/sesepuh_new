...
<head>
    ...
    <title>Login &mdash; Sesepuh</title>
            ...
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">SespuhID</span></h4>
                        ...
                        <div class="text-center mt-5 text-small">
                            Copyright &copy; SesepuhID <?= date('Y') ?>. Made with 💙 by Stisla
                            <div class="mt-2">
